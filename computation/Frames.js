...
Frames.osvJ2000ToCEP = function (osv_J2000, nutPar) {
  ...
  // (A.23):
  const z =
    0.6406161388 * T + 3.0407777777e-4 * T * T + 5.0563888888e-6 * T * T * T
  const nu =
    0.5567530277 * T - 1.1851388888e-4 * T * T - 1.1620277777e-5 * T * T * T
  const zeta =
    0.6406161388 * T + 8.3855555555e-5 * T * T + 4.9994444444e-6 * T * T * T
